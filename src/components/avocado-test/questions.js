const quizQuestionsData = [
  {
    ...
    shortAnswer: false,
    answer: `дурня, звичайно можна. Можна навіть в басейні!
  ...
  },
  {
    ...
    answer: `Ліпше не треба, але якщо дуже хочеться - можна.
     ...
     хтось може відчувати дискомфорт в шкірі голови під час місячних.
  ...
  },
  {
    ...
    shortAnswer: false,
    answer: `абсолютна туфта. Немає жодних доказів, що секс може негативно вплинути на жіноче
  ...
  },
  {
    ...
    shortAnswer: false,
    answer: `неправда, можна, особливо, якщо воно вже почало ставати темнішим та жорсткішим.
  ...
  },
  {
    ...
    shortAnswer: false,
    answer: `Ні, від мастурбації не можна ні осліпнути, ні позеленіти, ні померти.
  ...
  },
  {
    ...
    shortAnswer: false,
    answer: `Ні, це точно не свідчить про рак. Ця штука називається полюції
  ...
  },
  {
    ...
    shortAnswer: false,
    answer: `ні, зазвичай груди найбільше виростають якраз після того, як почалися місячні.
     Але цей процес дуже індивідуальний – в кожної дівчини він проходить по-різному. `
  },
  {
    question: 'Акне з’являється через нездорове харчування',
    shortAnswer: false,
    answer: `Ні. У підлітковому віці акне з’являється від шабашу, який в твоєму організмі влаштовують гормони.
  ...
  },
  {
    ...
    shortAnswer: false,
    answer: `ні, акне ніяк не пов’язане з сексом. Воно, як я вже писала,
